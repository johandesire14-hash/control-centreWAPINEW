...
if (process.env.ALLOW_DESTRUCTIVE_MIGRATION !== "true") {
  throw new Error(
    "Migration destructive bloquée. Utilisez la migration additive pour la production ou définissez ALLOW_DESTRUCTIVE_MIGRATION=true uniquement sur une base de développement jetable.",
  );
}
